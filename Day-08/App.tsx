...
import { View, Text, TextInput, Alert, TouchableOpacity, Button, FlatList, Image, ImageBackground,ScrollView,SectionList,SafeAreaView , Switch, Card,} from 'react-native';
...
const App = () => {
  ...
  /*const card= [
  { title: 'Card 1', image: 'https://encrypted-tbn0.gstatic.com/images?    q=tbn:ANd9GcQSlqaB8kiJd9BzLgSn3Ab_h_Ht7B-4cnH5JA&s'},
  //{ title: 'Card 2', image: 'https://www.onceuponachef.com/images/2019/04/Chocolate-Mousse.jpg' },
  { title: 'Card 3', image: 'https://theobroma.in/cdn/shop/files/EgglessDutchTrufflePastry.jpg?v=1711099798' },
];*/
